...
const DEFAULT_PIE_CONFIG = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.B.pie;
...
const addSection = (label, value) => {
  label = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.d)(label, (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  if (sections[label] === void 0) {
    sections[label] = value;
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`added new section: ${label}, with value: ${value}`);
  }
};
...
const draw = (text, id, _version, diagObj) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("rendering pie chart\n" + text);
  const db2 = diagObj.db;
  const globalConfig = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)();
  const pieConfig = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.C)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.D)(themeVariables.pieOuterStrokeWidth);
  ...
  (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.i)(svg, height, totalWidth, pieConfig.useMaxWidth);
};
const renderer = { draw };
const diagram = {
  parser: parser$1,
