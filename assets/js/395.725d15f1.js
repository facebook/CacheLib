...
const draw = (text, id, version) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("rendering info diagram\n" + text);
  const svg = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.A)(id);
  (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.i)(svg, 100, 400, true);
