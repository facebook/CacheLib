...
const drawStartState = (g) => g.append("circle").attr("class", "start-state").attr("r", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit).attr("cx", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit).attr("cy", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit);
const drawDivider = (g) => g.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight).attr("class", "divider").attr("x2", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight * 2).attr("y1", 0).attr("y2", 0);
const drawSimpleState = (g, stateDef) => {
  const state = g.append("text").attr("x", 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("font-size", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.fontSize).attr("class", "state-title").text(stateDef.id);
  const classBox = state.node().getBBox();
  g.insert("rect", ":first-child").attr("x", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("width", classBox.width + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("height", classBox.height + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("rx", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.radius);
  return state;
};
const drawDescrState = (g, stateDef) => {
  const addTspan = function(textEl, txt, isFirst2) {
    const tSpan = textEl.append("tspan").attr("x", 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).text(txt);
    if (!isFirst2) {
      tSpan.attr("dy", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight);
    }
  };
  const title = g.append("text").attr("x", 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight + 1.3 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("font-size", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.fontSize).attr("class", "state-title").text(stateDef.descriptions[0]);
  const titleBox = title.node().getBBox();
  const titleHeight = titleBox.height;
  const description = g.append("text").attr("x", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr(
    "y",
    titleHeight + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding * 0.4 + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.dividerMargin + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight
  ...
  const descrLine = g.append("line").attr("x1", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("y1", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + titleHeight + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.dividerMargin / 2).attr("y2", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + titleHeight + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.dividerMargin / 2).attr("class", "descr-divider");
  const descrBox = description.node().getBBox();
  const width = Math.max(descrBox.width, titleBox.width);
  descrLine.attr("x2", width + 3 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding);
  g.insert("rect", ":first-child").attr("x", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("width", width + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("height", descrBox.height + titleHeight + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("rx", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.radius);
  return g;
};
const addTitleAndBox = (g, stateDef, altBkg) => {
  const pad = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding;
  const dblPad = 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding;
  const orgBox = g.node().getBBox();
  const orgWidth = orgBox.width;
  const orgX = orgBox.x;
  const title = g.append("text").attr("x", 0).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.titleShift).attr("font-size", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.fontSize).attr("class", "state-title").text(stateDef.id);
  const titleBox = title.node().getBBox();
  ...
  const lineY = 1 - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight;
  g.insert("rect", ":first-child").attr("x", startX).attr("y", lineY).attr("class", altBkg ? "alt-composit" : "composit").attr("width", width).attr(
    "height",
    graphBox.height + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.titleShift + 1
  ).attr("rx", "0");
  ...
  g.insert("rect", ":first-child").attr("x", startX).attr(
    "y",
    (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.titleShift - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding
  ).attr("width", width).attr("height", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight * 3).attr("rx", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.radius);
  g.insert("rect", ":first-child").attr("x", startX).attr(
    "y",
    (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.titleShift - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding
  ).attr("width", width).attr("height", graphBox.height + 3 + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.textHeight).attr("rx", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.radius);
  return g;
};
const drawEndState = (g) => {
  g.append("circle").attr("class", "end-state-outer").attr("r", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.miniPadding).attr(
    "cx",
    (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.miniPadding
  ).attr(
    "cy",
    (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.miniPadding
  );
  return g.append("circle").attr("class", "end-state-inner").attr("r", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit).attr("cx", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit + 2).attr("cy", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.sizeUnit + 2);
};
const drawForkJoinState = (g, stateDef) => {
  let width = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.forkWidth;
  let height = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.forkHeight;
  if (stateDef.parentId) {
    let tmp = width;
    width = height;
    height = tmp;
  }
  return g.append("rect").style("stroke", "black").style("fill", "black").attr("width", width).attr("height", height).attr("x", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding);
};
const _drawLongText = (_text, x, y, g) => {
  ...
  text = text.replace(/\n/g, "<br/>");
  const lines = text.split(_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
  let tHeight = 1.25 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.noteMargin;
  for (const line2 of lines) {
    ...
    if (txt.length > 0) {
      ...
      textHeight += tHeight;
      span.attr("x", x + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.noteMargin);
      span.attr("y", y + textHeight + 1.25 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.noteMargin);
    }
  }
...
const drawNote = (text, g) => {
  ...
  const note = g.append("rect").attr("x", 0).attr("y", (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding);
  const rectElem = g.append("g");
  const { textWidth, textHeight } = _drawLongText(text, 0, 0, rectElem);
  note.attr("height", textHeight + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.noteMargin);
  note.attr("width", textWidth + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.noteMargin * 2);
  return note;
};
const drawState = function(elem, stateDef) {
  ...
  stateInfo.width = stateBox.width + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding;
  stateInfo.height = stateBox.height + 2 * (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding;
...
const drawEdge = function(elem, path, relation) {
  const getRelationType = function(type) {
    switch (type) {
      case _styles_0c0f8aee_js__WEBPACK_IMPORTED_MODULE_0__.d.relationType.AGGREGATION:
        return "aggregation";
      case _styles_0c0f8aee_js__WEBPACK_IMPORTED_MODULE_0__.d.relationType.EXTENSION:
        return "extension";
      case _styles_0c0f8aee_js__WEBPACK_IMPORTED_MODULE_0__.d.relationType.COMPOSITION:
        return "composition";
      case _styles_0c0f8aee_js__WEBPACK_IMPORTED_MODULE_0__.d.relationType.DEPENDENCY:
        return "dependency";
    }
  };
  ...
  let url = "";
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.arrowMarkerAbsolute) {
  ...
  svgPath.attr(
    "marker-end",
    "url(" + url + "#" + getRelationType(_styles_0c0f8aee_js__WEBPACK_IMPORTED_MODULE_0__.d.relationType.DEPENDENCY) + "End)"
  );
  if (relation.title !== void 0) {
    const label = elem.append("g").attr("class", "stateLabel");
    const { x, y } = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.u.calcLabelPosition(path.points);
    const rows = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.e.getRows(relation.title);
    let titleHeight = 0;
    const titleRows = [];
    let maxWidth = 0;
    let minX = 0;
    for (let i = 0; i <= rows.length; i++) {
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info(boundsTmp.x, x, y + titleHeight);
      if (titleHeight === 0) {
        const titleBox = title.node().getBBox();
        titleHeight = titleBox.height;
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Title height", titleHeight, y);
      }
    ...
    label.insert("rect", ":first-child").attr("class", "box").attr("x", x - maxWidth / 2 - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding / 2).attr("y", y - boxHeight / 2 - (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding / 2 - 3.5).attr("width", maxWidth + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding).attr("height", boxHeight + (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state.padding);
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info(bounds);
  }
  edgeCount++;
};
let conf;
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().state;
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Rendering diagram " + text);
  ...
  (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.i)(diagram2, height, svgWidth, conf.useMaxWidth);
  diagram2.attr(
    "viewBox",
...
const renderDoc = (doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Count=", graph.nodeCount(), graph);
  let cnt = 0;
  relations.forEach(function(relation) {
    cnt++;
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Setting edge", relation);
    graph.setEdge(
      relation.id1,
      relation.id2,
      {
        ...
        height: conf.labelHeight * _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.e.getRows(relation.title).length,
        labelpos: "c"
      },
      "id" + cnt
    );
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Graph after layout", graph.nodes());
  const svgElem = diagram2.node();
  graph.nodes().forEach(function(v) {
    if (v !== void 0 && graph.node(v) !== void 0) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Node " + v + ": " + JSON.stringify(graph.node(v)));
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("No Node " + v + ": " + JSON.stringify(graph.node(v)));
    }
  });
  let stateBox = svgElem.getBBox();
  graph.edges().forEach(function(e) {
    if (e !== void 0 && graph.edge(e) !== void 0) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Doc rendered", stateInfo, graph);
  return stateInfo;
};
const renderer = {
  setConf,
