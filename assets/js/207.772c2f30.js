...
const drawPopup = function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
  ...
  if (links != null) {
    ...
    for (let key in links) {
      ...
      var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeUrl */ .J)(links[key]);
...
const svgDraw = {
  ...
  getNoteRect,
  fixLifeLineHeights,
  sanitizeUrl: _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeUrl */ .J
};
let conf = {};
const bounds = {
  data: {
