...
/* harmony export */ });
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94763);
/* harmony import */ var mdast_util_from_markdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36650);
...
function addHtmlSpan(element, node, width, classes, addBackground = false) {
  ...
  div.html(
    (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.d)(
      `
    <span class="${labelClass} ${classes}" ` + (node.labelStyle ? 'style="' + node.labelStyle + '"' : "") + ">" + label + "</span>",
      (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.F)()
    )
  );
...
const createText = (el, text = "", {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.M)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
        // cspell: disable-line
...
/* harmony import */ var _createText_31840e8c_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(78664);
...
const extension = (elem, type, id) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.trace("Making markers for ", id);
...
const createLabel = (_vertexText, style, isTitle, isNode) => {
  ...
  const config = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)();
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.m)(config.flowchart.htmlLabels)) {
    vertexText = vertexText.replace(/\\n|\n/g, "<br />");
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("vertexText" + vertexText);
    const node = {
      isNode,
      label: (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.M)(vertexText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
        // cspell: disable-line
        (s) => `<i class='${s.replace(":", " ")}'></i>`
      ),
...
const labelHelper = async (parent, node, _classes, isNode) => {
  let classes;
  const useHtmlLabels = node.useHtmlLabels || (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.m)((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.htmlLabels);
  if (!_classes) {
  ...
  if (node.labelType === "markdown") {
    text = (0,_createText_31840e8c_js__WEBPACK_IMPORTED_MODULE_2__.a)(label, (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.d)((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.M)(labelText), (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)()), {
      useHtmlLabels,
      width: node.width || (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.wrappingWidth,
      classes: "markdown-node-label"
    });
  } else {
    text = textNode.appendChild(
      createLabel$1(
        (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.d)((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.M)(labelText), (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)()),
        node.labelStyle,
        false,
        isNode
      )
  ...
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.m)((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.htmlLabels)) {
        ...
        [...images].map(
          (img) => new Promise((res) => {
            function setupImage() {
              ...
              if (noImgText) {
                const bodyFontSize = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().fontSize ? (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().fontSize : window.getComputedStyle(document.body).fontSize;
...
const note = async (parent, node) => {
  const useHtmlLabels = node.useHtmlLabels || (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.htmlLabels;
  if (!useHtmlLabels) {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Classes = ", node.classes);
...
const question = async (parent, node) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Question main (Circle)");
  const questionElem = insertPolygonShape(shapeSvg, s, s, points);
  questionElem.attr("style", node.style);
  updateNodeBounds(node, questionElem);
  node.intersect = function(point2) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.warn("Intersect called");
...
const rect = async (parent, node) => {
  ...
  if (node.props) {
    ...
    propKeys.forEach((propKey) => {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.warn(`Unknown node property ${propKey}`);
    });
  }
  updateNodeBounds(node, rect2);
  node.intersect = function(point2) {
...
const labelRect = async (parent, node) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.trace("Classes = ", node.class);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const totalWidth = 0;
  const totalHeight = 0;
...
function applyNodePropertyBorders(rect2, borders, totalWidth, totalHeight) {
  ...
  if (borders.includes("t")) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("add top border");
    addBorder(totalWidth);
  } else {
    skipBorder(totalWidth);
  }
  if (borders.includes("r")) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("add right border");
    addBorder(totalHeight);
  } else {
    skipBorder(totalHeight);
  }
  if (borders.includes("b")) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("add bottom border");
    addBorder(totalWidth);
  } else {
    skipBorder(totalWidth);
  }
  if (borders.includes("l")) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("add left border");
    addBorder(totalHeight);
  } else {
    skipBorder(totalHeight);
  }
...
const rectWithTitle = (parent, node) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Label text abc79", title, text2, typeof text2 === "object");
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Text 2", text2);
...
const circle = async (parent, node) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Circle main");
  updateNodeBounds(node, circle2);
  node.intersect = function(point2) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Circle intersect", node, bbox.width / 2 + halfPadding, point2);
...
const doublecircle = async (parent, node) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("DoubleCircle main");
  updateNodeBounds(node, outerCircle);
  node.intersect = function(point2) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.info("DoubleCircle intersect", node, bbox.width / 2 + halfPadding + gap, point2);
...
const class_box = (parent, node) => {
  ...
  if (node.classData.type !== void 0 && node.classData.type !== "") {
    if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.htmlLabels) {
...
const insertNode = async (elem, node, dir) => {
  ...
  if (node.link) {
    let target;
    if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().securityLevel === "sandbox") {
      target = "_top";
...
const positionNode = (node) => {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.trace(
    "Transforming node",
    node.diff,
    node,
...
const addEdgeMarker = (svgPath, position, arrowType, url, id, diagramType) => {
  ...
  if (!endMarkerType) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.warn(`Unknown arrow type: ${arrowType}`);
    return;
  }
...
const insertEdgeLabel = (elem, edge) => {
  const useHtmlLabels = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.m)((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.htmlLabels);
...
function setTerminalWidth(fo, value) {
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.htmlLabels && fo) {
    fo.style.width = value.length * 9 + "px";
    fo.style.height = "12px";
  }
}
const positionEdgeLabel = (edge, paths) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Moving label abc88 ", edge.id, edge.label, edgeLabels[edge.id], paths);
  let path = paths.updatedPath ? paths.updatedPath : paths.originalPath;
  const siteConfig = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)();
  ...
  if (edge.label) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.u.calcLabelPosition(path);
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.u.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.u.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.u.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.u.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
const intersection = (node, outsidePoint, insidePoint) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`intersection calc abc89:
  ...
  if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
    ...
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`abc89 topp/bott calc, Q ${Q}, q ${q}, R ${R}, r ${r}`, res);
    return res;
  } else {
    ...
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, { _x, _y });
    if (r === 0) {
      _x = outsidePoint.x;
      _y = outsidePoint.y;
    }
...
const cutPathAtIntersect = (_points, boundaryNode) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("abc88 cutPathAtIntersect", _points, boundaryNode);
  let points = [];
...
const insertEdge = function(elem, e, edge, clusterDb, diagramType, graph, id) {
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("abc88 InsertEdge: edge=", edge, "e=", e);
  ...
  if (edge.toCluster) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("to cluster abc88", clusterDb[edge.toCluster]);
    points = cutPathAtIntersect(edge.points, clusterDb[edge.toCluster].node);
    pointsHasChanged = true;
  }
  if (edge.fromCluster) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("from cluster abc88", clusterDb[edge.fromCluster]);
  ...
  let url = "";
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().flowchart.arrowMarkerAbsolute || (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_0__.c)().state.arrowMarkerAbsolute) {
...
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94763);
...
/* harmony export */ });
/* harmony import */ var _flowDb_99855667_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22696);
/* harmony import */ var _styles_38506eb2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42514);
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94763);
...
const diagram = {
  parser: _flowDb_99855667_js__WEBPACK_IMPORTED_MODULE_0__.p,
  db: _flowDb_99855667_js__WEBPACK_IMPORTED_MODULE_0__.f,
  renderer: _styles_38506eb2_js__WEBPACK_IMPORTED_MODULE_1__.f,
  styles: _styles_38506eb2_js__WEBPACK_IMPORTED_MODULE_1__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_2__.p)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
    _styles_38506eb2_js__WEBPACK_IMPORTED_MODULE_1__.f.setConf(cnf.flowchart);
    _flowDb_99855667_js__WEBPACK_IMPORTED_MODULE_0__.f.clear();
    _flowDb_99855667_js__WEBPACK_IMPORTED_MODULE_0__.f.setGen("gen-2");
  }
};
...
/* harmony import */ var _edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74855);
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(94763);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(697);
/* harmony import */ var _createText_31840e8c_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(78664);
...
const isDescendant = (id, ancestorId) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("In isDescendant", ancestorId, " ", id, " = ", descendants[ancestorId].includes(id));
...
const edgeInCluster = (edge, clusterId) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Descendants of ", clusterId, " is ", descendants[clusterId]);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge is ", edge);
  if (edge.v === clusterId) {
    return false;
  }
  if (edge.w === clusterId) {
  ...
  if (!descendants[clusterId]) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Tilt, ", clusterId, ",not in descendants");
    return false;
  }
  return descendants[clusterId].includes(edge.v) || isDescendant(edge.v, clusterId) || isDescendant(edge.w, clusterId) || descendants[clusterId].includes(edge.w);
};
const copy = (clusterId, graph, newGraph, rootId) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn(
    "Copying children of ",
    clusterId,
    "root",
    rootId,
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Copying (nodes) clusterId", clusterId, "nodes", nodes);
  nodes.forEach((node) => {
    if (graph.children(node).length > 0) {
      copy(node, graph, newGraph, rootId);
    } else {
      const data = graph.node(node);
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("cp ", node, " to ", rootId, " with parent ", clusterId);
      newGraph.setNode(node, data);
      if (rootId !== graph.parent(node)) {
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Setting parent", node, graph.parent(node));
        newGraph.setParent(node, graph.parent(node));
      }
      if (clusterId !== rootId && node !== clusterId) {
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Setting parent", node, clusterId);
        newGraph.setParent(node, clusterId);
      } else {
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("In copy ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug(
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Copying Edges", edges);
      edges.forEach((edge) => {
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge", edge);
        const data2 = graph.edge(edge.v, edge.w, edge.name);
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge data", data2, rootId);
        try {
          if (edgeInCluster(edge, rootId)) {
            _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Copying as ", edge.v, edge.w, data2, edge.name);
            newGraph.setEdge(edge.v, edge.w, data2, edge.name);
            _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("newGraph edges ", newGraph.edges(), newGraph.edge(newGraph.edges()[0]));
          } else {
            _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info(
          ...
          _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.error(e);
        }
      });
    }
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Removing node", node);
...
const findNonClusterChild = (id, graph) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Searching", id);
  const children = graph.children(id);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Searching children of id ", id, children);
  if (children.length < 1) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("This is a valid node", id);
    return id;
  }
  for (const child of children) {
    const _id = findNonClusterChild(child, graph);
    if (_id) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Found replacement for", id, " => ", _id);
      return _id;
    }
  }
};
...
const adjustClustersAndEdges = (graph, depth) => {
  if (!graph || depth > 10) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Opting out, no graph ");
    return;
  } else {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Opting in, graph ");
  }
  ...
  graph.nodes().forEach(function(id) {
    ...
    if (children.length > 0) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Cluster identified", id, descendants);
      edges.forEach((edge) => {
        if (edge.v !== id && edge.w !== id) {
          const d1 = isDescendant(edge.v, id);
          const d2 = isDescendant(edge.w, id);
          if (d1 ^ d2) {
            _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Edge: ", edge, " leaves cluster ", id);
            _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Descendants of XXX ", id, ": ", descendants[id]);
            clusterDb[id].externalConnections = true;
          }
        }
      });
    } else {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Not a cluster ", id, descendants);
    }
  });
  ...
  graph.edges().forEach(function(e) {
    ...
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
    let v = e.v;
    let w = e.w;
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn(
      "Fix XXX",
    ...
    if (clusterDb[e.v] && clusterDb[e.w] && clusterDb[e.v] === clusterDb[e.w]) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Fixing and trixing link to self - removing XXX", e.v, e.w, e.name);
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Fixing and trixing - removing XXX", e.v, e.w, e.name);
      v = getAnchorId(e.v);
      w = getAnchorId(e.w);
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Fix Replacing with XXX", v, w, e.name);
      graph.setEdge(v, w, edge, e.name);
    }
  });
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  extractor(graph, 0);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph), graph.children("D"));
  if (depth > 10) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.error("Bailing out");
    return;
  }
  ...
  if (!hasChildren) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Done, no node has children", graph.nodes());
    return;
  }
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Nodes = ", nodes, depth);
  for (const node of nodes) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug(
      "Extracting node",
      node,
    ...
    if (!clusterDb[node]) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Not a cluster", node, depth);
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      if (clusterDb[node] && clusterDb[node].clusterData && clusterDb[node].clusterData.dir) {
        ...
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Fixing dir", clusterDb[node].clusterData.dir, dir);
      }
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(clusterGraph));
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
    } else {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn(
        "Cluster ** ",
        node,
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.debug(clusterDb);
    }
  }
  nodes = graph.nodes();
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("New list of nodes", nodes);
  for (const node of nodes) {
    const data = graph.node(node);
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn(" Now next level", node, data);
    if (data.clusterNode) {
...
const rect = (parent, node) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.c)();
  const shapeSvg = parent.insert("g").attr("class", "cluster" + (node.class ? " " + node.class : "")).attr("id", node.id);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const useHtmlLabels = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.m)(siteConfig.flowchart.htmlLabels);
  const label = shapeSvg.insert("g").attr("class", "cluster-label");
  const text = node.labelType === "markdown" ? (0,_createText_31840e8c_js__WEBPACK_IMPORTED_MODULE_5__.a)(label, node.labelText, { style: node.labelStyle, useHtmlLabels }) : label.node().appendChild((0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.c)(node.labelText, node.labelStyle, void 0, true));
  let bbox = text.getBBox();
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.m)(siteConfig.flowchart.htmlLabels)) {
    const div = text.children[0];
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Data ", node, JSON.stringify(node));
  rect2.attr("style", node.style).attr("rx", node.rx).attr("ry", node.ry).attr("x", node.x - width / 2).attr("y", node.y - node.height / 2 - halfPadding).attr("width", width).attr("height", node.height + padding);
  const { subGraphTitleTopMargin } = (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.g)(siteConfig);
  if (useHtmlLabels) {
    label.attr(
      "transform",
  ...
  node.intersect = function(point) {
    return (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.i)(node, point);
  };
  return shapeSvg;
};
...
const roundedWithTitle = (parent, node) => {
  ...
  const text = label.node().appendChild((0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.c)(node.labelText, node.labelStyle, void 0, true));
  let bbox = text.getBBox();
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.m)(siteConfig.flowchart.htmlLabels)) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ltv)(text);
  ...
  label.attr(
    "transform",
    `translate(${node.x - bbox.width / 2}, ${node.y - node.height / 2 - node.padding / 3 + ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.m)(siteConfig.flowchart.htmlLabels) ? 5 : 3) + subGraphTitleTopMargin})`
  );
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.intersect = function(point) {
...
const insertCluster = (elem, node) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Inserting cluster");
...
const recursiveRender = async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph), parentCluster);
  const dir = graph.graph().rankdir;
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Dir in recursive render - dir:", dir);
  const elem = _elem.insert("g").attr("class", "root");
  if (!graph.nodes()) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("No nodes found for", graph);
  } else {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Recursive render XXX", graph.nodes());
  }
  if (graph.edges().length > 0) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Recursive edges", graph.edge(graph.edges()[0]));
  }
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (parentCluster !== void 0) {
        ...
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Setting data for cluster XXX (", v, ") ", data, parentCluster);
        graph.setNode(parentCluster.id, data);
        if (!graph.parent(v)) {
          _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Setting parent", v, parentCluster.id);
          graph.setParent(v, parentCluster.id, data);
        }
      }
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("(Insert) Node XXX" + v + ": " + JSON.stringify(graph.node(v)));
      if (node && node.clusterNode) {
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Cluster identified", v, node.width, graph.node(v));
        ...
        const newEl = o.elem;
        (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.u)(node, newEl);
        node.diff = o.diff || 0;
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Node bounds (abc123)", v, node, node.width, node.x, node.y);
        (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.s)(newEl, node);
        _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Recursive render complete ", newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Cluster - the non recursive path XXX", v, node.id, node, graph);
          _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info(findNonClusterChild(node.id, graph));
          clusterDb[node.id] = { id: findNonClusterChild(node.id, graph), node };
        } else {
          _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Node - the non recursive path", v, node.id, node);
          await (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.e)(nodes, graph.node(v), dir);
        }
      }
    })
  );
  graph.edges().forEach(function(e) {
    ...
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge " + e.v + " -> " + e.w + ": ", e, " ", JSON.stringify(graph.edge(e)));
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Fix", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb[e.v], clusterDb[e.w]);
    (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.f)(edgeLabels, edge);
  });
  graph.edges().forEach(function(e) {
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
  });
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("#############################################");
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("###                Layout                 ###");
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("#############################################");
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info(graph);
  (0,dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__/* .layout */ .Zp)(graph);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  let diff = 0;
  const { subGraphTitleTotalMargin } = (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.g)(siteConfig);
  sortNodesByHierarchy(graph).forEach(function(v) {
    const node = graph.node(v);
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Position " + v + ": " + JSON.stringify(graph.node(v)));
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info(
      "Position " + v + ": (" + node.x,
      "," + node.y,
      ") width: ",
    ...
    if (node && node.clusterNode) {
      ...
      (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.p)(node);
    } else {
      if (graph.children(v).length > 0) {
  ...
  graph.edges().forEach(function(e) {
    const edge = graph.edge(e);
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(edge), edge);
    edge.points.forEach((point) => point.y += subGraphTitleTotalMargin / 2);
    const paths = (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.h)(edgePaths, e, edge, clusterDb, diagramType, graph, id);
    (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.j)(edge, paths);
  });
  graph.nodes().forEach(function(v) {
    const n = graph.node(v);
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.info(v, n.type, n.diff);
    if (n.type === "group") {
      diff = n.diff;
    }
  });
...
const render = async (elem, graph, markers, diagramType, id) => {
  (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.a)(elem, markers, diagramType, id);
  (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.b)();
  (0,_edges_c9cd0ec5_js__WEBPACK_IMPORTED_MODULE_2__.d)();
  clear();
  clear$1();
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph)));
  const siteConfig = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_3__.c)();
...
/* harmony import */ var _index_bf99f535_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37082);
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(94763);
...
const addVertices = async function(vert, g, svgId, root, doc, diagObj) {
  ...
  for (const id of keys) {
    ...
    const styles = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("vertex", vertex, vertex.labelType);
    } else {
      if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.m)((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels)) {
        const node = {
          label: vertexText
        };
        ...
        const rows = vertexText.split(_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
        for (const row of rows) {
    ...
    const labelText = await (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.r)(vertexText, (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)());
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.padding
    });
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText,
...
const addEdges = async function(edges, g, diagObj) {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.k)(edges.defaultStyle);
  ...
  for (const edge of edges) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
    ...
    edgeData.label = await (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.r)(
      edge.text.replace(_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex, "\n"),
      (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)()
    );
    if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Drawing flowchart");
  let dir = diagObj.db.getDirection();
  if (dir === void 0) {
    dir = "TD";
  }
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Subgraph - ", subG);
  ...
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ubm)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  await (0,_index_bf99f535_js__WEBPACK_IMPORTED_MODULE_3__.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_4__.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
