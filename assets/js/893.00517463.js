...
/* harmony import */ var _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(94763);
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Invalid date:" + str);
    _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.c)().securityLevel !== "loose") {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  getConfig: () => (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.c)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
...
const setConf = function() {
  _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Something is calling, setConf, remove the call");
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.c)().gantt;
  const securityLevel = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.c)().securityLevel;
  let sandboxElement;
  ...
  (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.i)(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.c)().securityLevel;
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_1__(maxTime).diff(dayjs__WEBPACK_IMPORTED_MODULE_1__(minTime), "year") > 5) {
      _mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.l.warn(
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurrences).enter().append(function(d) {
      const rows = d[0].split(_mermaid_59c9be08_js__WEBPACK_IMPORTED_MODULE_5__.e.lineBreakRegex);
