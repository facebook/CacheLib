...
CMAKE_PARAMS="-DCMAKE_INSTALL_PREFIX='$PREFIX' -DCMAKE_MODULE_PATH='$CLCMAKE' -DCMAKE_BUILD_TYPE=Debug -DGLOG_LIBRARYDIR='$PREFIXB/glog-d0ga0GeTcb_RtwEq1XZwx252avcQvY5AVUshDhtM7bg/lib' -DGLOG_INCLUDE_DIR='$PREFIXB/glog-d0ga0GeTcb_RtwEq1XZwx252avcQvY5AVUshDhtM7bg/include'"
