...
TEST_F(MemoryPoolTest, InvalidDeSerialization) {
  ...
  incorrectAllocSizeState.currAllocSize =
      correctState.currSlabAllocSize + folly::Random::rand32() % Slab::kSize +
      1;
  ...
  incorrectSlabAllocSizeState.currSlabAllocSize =
      correctState.currAllocSize - (folly::Random::rand32() % Slab::kSize) - 1;
  ...
  incorrectSizesState = correctState;
  incorrectSizesState.acSizes.push_back(incorrectSizesState.acSizes.back());
